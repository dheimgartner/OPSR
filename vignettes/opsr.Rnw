...
\pkg{OPSR}~\Sexpr{packageVersion("OPSR")}, \pkg{MASS}~\Sexpr{packageVersion("MASS")}, \pkg{texreg}~\Sexpr{packageVersion("texreg")} and \pkg{gridExtra}~\Sexpr{packageVersion("gridExtra")}. \proglang{R} itself
