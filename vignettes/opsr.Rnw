...
start[fixed] <- 0
fit_nocor <- opsr(f_red, timeuse_data, start = start, fixed = fixed, printLevel = 0)
@
%
...
twdiff1 <- top["WFH (days)", "NUTW"] - top["WFH (days)", "NTW"]
twdiff2 <- top["WFH (days)", "UTW"] - top["WFH (days)", "NTW"]
twdiff3 <- top["WFH (days)", "UTW"] - top["WFH (days)", "NUTW"]
